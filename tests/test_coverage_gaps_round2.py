...
class TestHistoryHelpers:
    ...
    def test_source_identity_url(self) -> None:
        ...
        result = _source_identity({"kind": "url", "value": "https://example.com", "normalized_url": "https://example.com/"})
        assert result[0] == "url"
    ...
    def test_json_int_map_with_negatives(self) -> None:
        ...
        result = _json_int_map('{"a": 5, "b": -1, "c": "3", "d": "not_a_number"}')
        assert result["a"] == 5
        assert result["b"] == -1
        assert result["c"] == 3
